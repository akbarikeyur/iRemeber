...
class EditQuestionVC: UIViewController , UITableViewDelegate, UITableViewDataSource , AddPracticeTVCDelegate {
    ...
    override func viewDidLoad() {
        ...
        shuffleDictArr = CoreDataUtility.shared.fatchQuestionAnswer(TableName: "AboutMeQuestion")
